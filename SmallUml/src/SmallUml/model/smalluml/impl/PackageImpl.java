 ...
 * <ul>
 *   <li>{@link SmallUml.model.smalluml.impl.PackageImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link SmallUml.model.smalluml.impl.PackageImpl#getRelation <em>Relation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PackageImpl extends NamedElementImpl implements SmallUml.model.smalluml.Package {
	/**
	 ...
	 * @ordered
	 */
	protected EList<SmallUml.model.smalluml.Class> class_;
	 ...
	 * @generated
	 */
	public EList<SmallUml.model.smalluml.Class> getClass_() {
		if (class_ == null) {
			class_ = new EObjectContainmentEList<SmallUml.model.smalluml.Class>(SmallUml.model.smalluml.Class.class, this, SmallumlPackage.PACKAGE__CLASS);
		}
		return class_;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case SmallumlPackage.PACKAGE__CLASS:
				getClass_().clear();
				getClass_().addAll((Collection<? extends SmallUml.model.smalluml.Class>)newValue);
				return;
			case SmallumlPackage.PACKAGE__RELATION:
				getRelation().clear();
