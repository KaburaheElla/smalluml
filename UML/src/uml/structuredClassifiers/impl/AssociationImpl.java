 ...
 * </p>
 * <ul>
 *   <li>{@link uml.structuredClassifiers.impl.AssociationImpl#getRelatedElement <em>Related Element</em>}</li>
 *   <li>{@link uml.structuredClassifiers.impl.AssociationImpl#getMemberEnd <em>Member End</em>}</li>
 *   <li>{@link uml.structuredClassifiers.impl.AssociationImpl#getOwnedEnd <em>Owned End</em>}</li>
 *   <li>{@link uml.structuredClassifiers.impl.AssociationImpl#getEndType <em>End Type</em>}</li>
 *   <li>{@link uml.structuredClassifiers.impl.AssociationImpl#isIsDerived <em>Is Derived</em>}</li>
 *   <li>{@link uml.structuredClassifiers.impl.AssociationImpl#getNavigableOwnedEnd <em>Navigable Owned End</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AssociationImpl extends ClassifierImpl implements Association {
	...
	protected EClass eStaticClass() {
		return StructuredClassifiersPackage.Literals.ASSOCIATION;
	}
	...
	public EList<Property> getMemberEnd() {
		if (memberEnd == null) {
			memberEnd = new EObjectWithInverseResolvingEList<Property>(Property.class, this, StructuredClassifiersPackage.ASSOCIATION__MEMBER_END, ClassificationPackage.PROPERTY__ASSOCIATION);
		}
		return memberEnd;
	}
	...
	public EList<Property> getOwnedEnd() {
		if (ownedEnd == null) {
			ownedEnd = new EObjectContainmentWithInverseEList<Property>(Property.class, this, StructuredClassifiersPackage.ASSOCIATION__OWNED_END, ClassificationPackage.PROPERTY__OWNING_ASSOCIATION);
		}
		return ownedEnd;
	}
	...
	public void setIsDerived(boolean newIsDerived) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredClassifiersPackage.ASSOCIATION__IS_DERIVED, oldIsDerived, isDerived));
	}
	...
	public EList<Property> getNavigableOwnedEnd() {
		if (navigableOwnedEnd == null) {
			navigableOwnedEnd = new EObjectResolvingEList<Property>(Property.class, this, StructuredClassifiersPackage.ASSOCIATION__NAVIGABLE_OWNED_END);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StructuredClassifiersPackage.ASSOCIATION__MEMBER_END:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getMemberEnd()).basicAdd(otherEnd, msgs);
			case StructuredClassifiersPackage.ASSOCIATION__OWNED_END:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StructuredClassifiersPackage.ASSOCIATION__RELATED_ELEMENT:
				return getRelatedElement();
			case StructuredClassifiersPackage.ASSOCIATION__MEMBER_END:
				return getMemberEnd();
			case StructuredClassifiersPackage.ASSOCIATION__OWNED_END:
				return getOwnedEnd();
			case StructuredClassifiersPackage.ASSOCIATION__END_TYPE:
				return getEndType();
			case StructuredClassifiersPackage.ASSOCIATION__IS_DERIVED:
				return isIsDerived();
			case StructuredClassifiersPackage.ASSOCIATION__NAVIGABLE_OWNED_END:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Relationship.class) {
			switch (derivedFeatureID) {
				case StructuredClassifiersPackage.ASSOCIATION__RELATED_ELEMENT: return CommonStructurePackage.RELATIONSHIP__RELATED_ELEMENT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Relationship.class) {
			switch (baseFeatureID) {
				case CommonStructurePackage.RELATIONSHIP__RELATED_ELEMENT: return StructuredClassifiersPackage.ASSOCIATION__RELATED_ELEMENT;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case StructuredClassifiersPackage.ASSOCIATION___END_TYPE:
				return endType();
		}
