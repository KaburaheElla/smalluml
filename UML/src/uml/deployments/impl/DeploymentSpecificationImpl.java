 ...
 * </p>
 * <ul>
 *   <li>{@link uml.deployments.impl.DeploymentSpecificationImpl#getDeploymentLocation <em>Deployment Location</em>}</li>
 *   <li>{@link uml.deployments.impl.DeploymentSpecificationImpl#getExecutionLocation <em>Execution Location</em>}</li>
 *   <li>{@link uml.deployments.impl.DeploymentSpecificationImpl#getDeployment <em>Deployment</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeploymentSpecificationImpl extends ArtifactImpl implements DeploymentSpecification {
	...
	protected EClass eStaticClass() {
		return DeploymentsPackage.Literals.DEPLOYMENT_SPECIFICATION;
	}
	...
	public void setDeploymentLocation(String newDeploymentLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeploymentsPackage.DEPLOYMENT_SPECIFICATION__DEPLOYMENT_LOCATION, oldDeploymentLocation, deploymentLocation));
	}
	...
	public void setExecutionLocation(String newExecutionLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeploymentsPackage.DEPLOYMENT_SPECIFICATION__EXECUTION_LOCATION, oldExecutionLocation, executionLocation));
	}
	...
	public Deployment getDeployment() {
		if (eContainerFeatureID() != DeploymentsPackage.DEPLOYMENT_SPECIFICATION__DEPLOYMENT) return null;
	...
	public NotificationChain basicSetDeployment(Deployment newDeployment, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newDeployment, DeploymentsPackage.DEPLOYMENT_SPECIFICATION__DEPLOYMENT, msgs);
		return msgs;
	}
	...
	public void setDeployment(Deployment newDeployment) {
		if (newDeployment != eInternalContainer() || (eContainerFeatureID() != DeploymentsPackage.DEPLOYMENT_SPECIFICATION__DEPLOYMENT && newDeployment != null)) {
			...
			if (newDeployment != null)
				msgs = ((InternalEObject)newDeployment).eInverseAdd(this, DeploymentsPackage.DEPLOYMENT__CONFIGURATION, Deployment.class, msgs);
			msgs = basicSetDeployment(newDeployment, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeploymentsPackage.DEPLOYMENT_SPECIFICATION__DEPLOYMENT, newDeployment, newDeployment));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DeploymentsPackage.DEPLOYMENT_SPECIFICATION__DEPLOYMENT:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case DeploymentsPackage.DEPLOYMENT_SPECIFICATION__DEPLOYMENT:
				return eInternalContainer().eInverseRemove(this, DeploymentsPackage.DEPLOYMENT__CONFIGURATION, Deployment.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DeploymentsPackage.DEPLOYMENT_SPECIFICATION__DEPLOYMENT_LOCATION:
				return getDeploymentLocation();
			case DeploymentsPackage.DEPLOYMENT_SPECIFICATION__EXECUTION_LOCATION:
