 ...
 * </p>
 * <ul>
 *   <li>{@link uml.values.impl.LiteralRealImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LiteralRealImpl extends LiteralSpecificationImpl implements LiteralReal {
	...
	protected EClass eStaticClass() {
		return ValuesPackage.Literals.LITERAL_REAL;
	}
	...
	public void setValue(double newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuesPackage.LITERAL_REAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ValuesPackage.LITERAL_REAL__VALUE:
				return getValue();
		}
