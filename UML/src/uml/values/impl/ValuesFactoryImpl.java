...
public class ValuesFactoryImpl extends EFactoryImpl implements ValuesFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ValuesPackage.DURATION: return createDuration();
			case ValuesPackage.DURATION_CONSTRAINT: return createDurationConstraint();
			case ValuesPackage.INTERVAL_CONSTRAINT: return createIntervalConstraint();
			case ValuesPackage.INTERVAL: return createInterval();
			case ValuesPackage.DURATION_INTERVAL: return createDurationInterval();
			case ValuesPackage.DURATION_OBSERVATION: return createDurationObservation();
			case ValuesPackage.EXPRESSION: return createExpression();
			case ValuesPackage.LITERAL_BOOLEAN: return createLiteralBoolean();
			case ValuesPackage.LITERAL_INTEGER: return createLiteralInteger();
			case ValuesPackage.LITERAL_NULL: return createLiteralNull();
			case ValuesPackage.LITERAL_REAL: return createLiteralReal();
			case ValuesPackage.LITERAL_STRING: return createLiteralString();
			case ValuesPackage.LITERAL_UNLIMITED_NATURAL: return createLiteralUnlimitedNatural();
			case ValuesPackage.OPAQUE_EXPRESSION: return createOpaqueExpression();
			case ValuesPackage.TIME_CONSTRAINT: return createTimeConstraint();
			case ValuesPackage.TIME_INTERVAL: return createTimeInterval();
			case ValuesPackage.TIME_EXPRESSION: return createTimeExpression();
			case ValuesPackage.TIME_OBSERVATION: return createTimeObservation();
			case ValuesPackage.STRING_EXPRESSION: return createStringExpression();
			default:
