 ...
 * </p>
 * <ul>
 *   <li>{@link uml.values.impl.LiteralIntegerImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LiteralIntegerImpl extends LiteralSpecificationImpl implements LiteralInteger {
	...
	protected EClass eStaticClass() {
		return ValuesPackage.Literals.LITERAL_INTEGER;
	}
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuesPackage.LITERAL_INTEGER__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ValuesPackage.LITERAL_INTEGER__VALUE:
				return getValue();
		}
