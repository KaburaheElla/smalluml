 ...
 * </p>
 * <ul>
 *   <li>{@link uml.values.impl.TimeObservationImpl#getEvent <em>Event</em>}</li>
 *   <li>{@link uml.values.impl.TimeObservationImpl#isFirstEvent <em>First Event</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeObservationImpl extends ObservationImpl implements TimeObservation {
	...
	protected EClass eStaticClass() {
		return ValuesPackage.Literals.TIME_OBSERVATION;
	}
		...
		if (event != null && event.eIsProxy()) {
			...
			if (event != oldEvent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ValuesPackage.TIME_OBSERVATION__EVENT, oldEvent, event));
			}
		}
		return event;
	}
	...
	public void setEvent(NamedElement newEvent) {
		...
		event = newEvent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuesPackage.TIME_OBSERVATION__EVENT, oldEvent, event));
	}
	...
	public void setFirstEvent(boolean newFirstEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuesPackage.TIME_OBSERVATION__FIRST_EVENT, oldFirstEvent, firstEvent));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ValuesPackage.TIME_OBSERVATION__EVENT:
				if (resolve) return getEvent();
				return basicGetEvent();
			case ValuesPackage.TIME_OBSERVATION__FIRST_EVENT:
				return isFirstEvent();
		}
