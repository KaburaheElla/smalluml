 ...
 * </p>
 * <ul>
 *   <li>{@link uml.values.impl.ExpressionImpl#getOperand <em>Operand</em>}</li>
 *   <li>{@link uml.values.impl.ExpressionImpl#getSymbol <em>Symbol</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExpressionImpl extends ValueSpecificationImpl implements Expression {
	...
	public EList<ValueSpecification> getOperand() {
		if (operand == null) {
			operand = new EObjectContainmentEList<ValueSpecification>(ValueSpecification.class, this, ValuesPackage.EXPRESSION__OPERAND);
		}
		return operand;
	}
	...
	public void setSymbol(String newSymbol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuesPackage.EXPRESSION__SYMBOL, oldSymbol, symbol));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ValuesPackage.EXPRESSION__OPERAND:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ValuesPackage.EXPRESSION__OPERAND:
				return getOperand();
			case ValuesPackage.EXPRESSION__SYMBOL:
				return getSymbol();
		}
