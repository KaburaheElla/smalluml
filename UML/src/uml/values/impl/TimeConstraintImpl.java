 ...
 * </p>
 * <ul>
 *   <li>{@link uml.values.impl.TimeConstraintImpl#isFirstEvent <em>First Event</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeConstraintImpl extends IntervalConstraintImpl implements TimeConstraint {
	...
	protected EClass eStaticClass() {
		return ValuesPackage.Literals.TIME_CONSTRAINT;
	}
	...
	public void setFirstEvent(boolean newFirstEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuesPackage.TIME_CONSTRAINT__FIRST_EVENT, oldFirstEvent, firstEvent));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ValuesPackage.TIME_CONSTRAINT__FIRST_EVENT:
				return isFirstEvent();
		}
