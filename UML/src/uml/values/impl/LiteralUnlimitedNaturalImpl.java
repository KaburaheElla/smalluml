 ...
 * </p>
 * <ul>
 *   <li>{@link uml.values.impl.LiteralUnlimitedNaturalImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LiteralUnlimitedNaturalImpl extends LiteralSpecificationImpl implements LiteralUnlimitedNatural {
	...
	protected EClass eStaticClass() {
		return ValuesPackage.Literals.LITERAL_UNLIMITED_NATURAL;
	}
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuesPackage.LITERAL_UNLIMITED_NATURAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ValuesPackage.LITERAL_UNLIMITED_NATURAL__VALUE:
				return getValue();
		}
