 ...
 * </p>
 * <ul>
 *   <li>{@link uml.values.impl.LiteralBooleanImpl#isValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LiteralBooleanImpl extends LiteralSpecificationImpl implements LiteralBoolean {
	...
	protected EClass eStaticClass() {
		return ValuesPackage.Literals.LITERAL_BOOLEAN;
	}
	...
	public void setValue(boolean newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuesPackage.LITERAL_BOOLEAN__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ValuesPackage.LITERAL_BOOLEAN__VALUE:
				return isValue();
		}
