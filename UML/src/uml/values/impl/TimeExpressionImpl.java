 ...
 * </p>
 * <ul>
 *   <li>{@link uml.values.impl.TimeExpressionImpl#getExpr <em>Expr</em>}</li>
 *   <li>{@link uml.values.impl.TimeExpressionImpl#getObservation <em>Observation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeExpressionImpl extends ValueSpecificationImpl implements TimeExpression {
	...
	protected EClass eStaticClass() {
		return ValuesPackage.Literals.TIME_EXPRESSION;
	}
	...
	public NotificationChain basicSetExpr(ValueSpecification newExpr, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ValuesPackage.TIME_EXPRESSION__EXPR, oldExpr, newExpr);
	...
	public void setExpr(ValueSpecification newExpr) {
		if (newExpr != expr) {
			...
			if (expr != null)
				msgs = ((InternalEObject)expr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ValuesPackage.TIME_EXPRESSION__EXPR, null, msgs);
			if (newExpr != null)
				msgs = ((InternalEObject)newExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ValuesPackage.TIME_EXPRESSION__EXPR, null, msgs);
			msgs = basicSetExpr(newExpr, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuesPackage.TIME_EXPRESSION__EXPR, newExpr, newExpr));
	}
	...
	public EList<Observation> getObservation() {
		if (observation == null) {
			observation = new EObjectResolvingEList<Observation>(Observation.class, this, ValuesPackage.TIME_EXPRESSION__OBSERVATION);
		}
		return observation;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ValuesPackage.TIME_EXPRESSION__EXPR:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ValuesPackage.TIME_EXPRESSION__EXPR:
				return getExpr();
			case ValuesPackage.TIME_EXPRESSION__OBSERVATION:
