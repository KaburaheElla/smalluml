 ...
 * </p>
 * <ul>
 *   <li>{@link uml.values.impl.LiteralStringImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LiteralStringImpl extends LiteralSpecificationImpl implements LiteralString {
	...
	protected EClass eStaticClass() {
		return ValuesPackage.Literals.LITERAL_STRING;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuesPackage.LITERAL_STRING__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ValuesPackage.LITERAL_STRING__VALUE:
				return getValue();
		}
