 ...
 * </p>
 * <ul>
 *   <li>{@link uml.packages.impl.ModelImpl#getViewpoint <em>Viewpoint</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelImpl extends PackageImpl implements Model {
	...
	protected EClass eStaticClass() {
		return PackagesPackage.Literals.MODEL;
	}
	...
	public void setViewpoint(String newViewpoint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PackagesPackage.MODEL__VIEWPOINT, oldViewpoint, viewpoint));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PackagesPackage.MODEL__VIEWPOINT:
				return getViewpoint();
		}
