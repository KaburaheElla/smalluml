 ...
 * </p>
 * <ul>
 *   <li>{@link uml.commonStructure.impl.RelationshipImpl#getRelatedElement <em>Related Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class RelationshipImpl extends ElementImpl implements Relationship {
	...
	protected EClass eStaticClass() {
		return CommonStructurePackage.Literals.RELATIONSHIP;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CommonStructurePackage.RELATIONSHIP__RELATED_ELEMENT:
