 ...
 * </p>
 * <ul>
 *   <li>{@link uml.commonStructure.impl.CommentImpl#getAnnotatedElement <em>Annotated Element</em>}</li>
 *   <li>{@link uml.commonStructure.impl.CommentImpl#getBody <em>Body</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CommentImpl extends ElementImpl implements Comment {
	...
	protected EClass eStaticClass() {
		return CommonStructurePackage.Literals.COMMENT;
	}
	...
	public EList<Element> getAnnotatedElement() {
		if (annotatedElement == null) {
			annotatedElement = new EObjectResolvingEList<Element>(Element.class, this, CommonStructurePackage.COMMENT__ANNOTATED_ELEMENT);
		}
	...
	public void setBody(String newBody) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommonStructurePackage.COMMENT__BODY, oldBody, body));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CommonStructurePackage.COMMENT__ANNOTATED_ELEMENT:
				return getAnnotatedElement();
			case CommonStructurePackage.COMMENT__BODY:
				return getBody();
		}
