 ...
 * </p>
 * <ul>
 *   <li>{@link uml.simpleClassifiers.impl.EnumerationImpl#getOwnedLiteral <em>Owned Literal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumerationImpl extends DataTypeImpl implements Enumeration {
	...
	protected EClass eStaticClass() {
		return SimpleClassifiersPackage.Literals.ENUMERATION;
	}
	...
	public EList<EnumerationLiteral> getOwnedLiteral() {
		if (ownedLiteral == null) {
			ownedLiteral = new EObjectContainmentWithInverseEList<EnumerationLiteral>(EnumerationLiteral.class, this, SimpleClassifiersPackage.ENUMERATION__OWNED_LITERAL, SimpleClassifiersPackage.ENUMERATION_LITERAL__ENUMERATION);
		}
		return ownedLiteral;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SimpleClassifiersPackage.ENUMERATION__OWNED_LITERAL:
