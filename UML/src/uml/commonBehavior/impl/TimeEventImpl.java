 ...
 * </p>
 * <ul>
 *   <li>{@link uml.commonBehavior.impl.TimeEventImpl#isIsRelative <em>Is Relative</em>}</li>
 *   <li>{@link uml.commonBehavior.impl.TimeEventImpl#getWhen <em>When</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeEventImpl extends EventImpl implements TimeEvent {
	...
	protected EClass eStaticClass() {
		return CommonBehaviorPackage.Literals.TIME_EVENT;
	}
	...
	public void setIsRelative(boolean newIsRelative) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommonBehaviorPackage.TIME_EVENT__IS_RELATIVE, oldIsRelative, isRelative));
	}
	...
	public NotificationChain basicSetWhen(TimeExpression newWhen, NotificationChain msgs) {
		...
		when = newWhen;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CommonBehaviorPackage.TIME_EVENT__WHEN, oldWhen, newWhen);
	...
	public void setWhen(TimeExpression newWhen) {
		if (newWhen != when) {
			...
			if (when != null)
				msgs = ((InternalEObject)when).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CommonBehaviorPackage.TIME_EVENT__WHEN, null, msgs);
			if (newWhen != null)
				msgs = ((InternalEObject)newWhen).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CommonBehaviorPackage.TIME_EVENT__WHEN, null, msgs);
			msgs = basicSetWhen(newWhen, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommonBehaviorPackage.TIME_EVENT__WHEN, newWhen, newWhen));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CommonBehaviorPackage.TIME_EVENT__WHEN:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CommonBehaviorPackage.TIME_EVENT__IS_RELATIVE:
				return isIsRelative();
			case CommonBehaviorPackage.TIME_EVENT__WHEN:
				return getWhen();
		}
