 ...
 * </p>
 * <ul>
 *   <li>{@link uml.actions.impl.AddStructuralFeatureValueActionImpl#getInsertAt <em>Insert At</em>}</li>
 *   <li>{@link uml.actions.impl.AddStructuralFeatureValueActionImpl#isIsReplaceAll <em>Is Replace All</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AddStructuralFeatureValueActionImpl extends WriteStructuralFeatureActionImpl implements AddStructuralFeatureValueAction {
	...
	protected EClass eStaticClass() {
		return ActionsPackage.Literals.ADD_STRUCTURAL_FEATURE_VALUE_ACTION;
	}
	...
	public NotificationChain basicSetInsertAt(InputPin newInsertAt, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ActionsPackage.ADD_STRUCTURAL_FEATURE_VALUE_ACTION__INSERT_AT, oldInsertAt, newInsertAt);
	...
	public void setInsertAt(InputPin newInsertAt) {
		if (newInsertAt != insertAt) {
			...
			if (insertAt != null)
				msgs = ((InternalEObject)insertAt).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ActionsPackage.ADD_STRUCTURAL_FEATURE_VALUE_ACTION__INSERT_AT, null, msgs);
			if (newInsertAt != null)
				msgs = ((InternalEObject)newInsertAt).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ActionsPackage.ADD_STRUCTURAL_FEATURE_VALUE_ACTION__INSERT_AT, null, msgs);
			msgs = basicSetInsertAt(newInsertAt, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionsPackage.ADD_STRUCTURAL_FEATURE_VALUE_ACTION__INSERT_AT, newInsertAt, newInsertAt));
	}
	...
	public void setIsReplaceAll(boolean newIsReplaceAll) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionsPackage.ADD_STRUCTURAL_FEATURE_VALUE_ACTION__IS_REPLACE_ALL, oldIsReplaceAll, isReplaceAll));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ActionsPackage.ADD_STRUCTURAL_FEATURE_VALUE_ACTION__INSERT_AT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActionsPackage.ADD_STRUCTURAL_FEATURE_VALUE_ACTION__INSERT_AT:
				return getInsertAt();
			case ActionsPackage.ADD_STRUCTURAL_FEATURE_VALUE_ACTION__IS_REPLACE_ALL:
