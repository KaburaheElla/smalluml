 ...
 * </p>
 * <ul>
 *   <li>{@link uml.actions.impl.RemoveVariableValueActionImpl#isIsRemoveDuplicates <em>Is Remove Duplicates</em>}</li>
 *   <li>{@link uml.actions.impl.RemoveVariableValueActionImpl#getRemoveAt <em>Remove At</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RemoveVariableValueActionImpl extends WriteVariableActionImpl implements RemoveVariableValueAction {
	...
	protected EClass eStaticClass() {
		return ActionsPackage.Literals.REMOVE_VARIABLE_VALUE_ACTION;
	}
	...
	public void setIsRemoveDuplicates(boolean newIsRemoveDuplicates) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionsPackage.REMOVE_VARIABLE_VALUE_ACTION__IS_REMOVE_DUPLICATES, oldIsRemoveDuplicates, isRemoveDuplicates));
	}
	...
	public NotificationChain basicSetRemoveAt(InputPin newRemoveAt, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ActionsPackage.REMOVE_VARIABLE_VALUE_ACTION__REMOVE_AT, oldRemoveAt, newRemoveAt);
	...
	public void setRemoveAt(InputPin newRemoveAt) {
		if (newRemoveAt != removeAt) {
			...
			if (removeAt != null)
				msgs = ((InternalEObject)removeAt).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ActionsPackage.REMOVE_VARIABLE_VALUE_ACTION__REMOVE_AT, null, msgs);
			if (newRemoveAt != null)
				msgs = ((InternalEObject)newRemoveAt).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ActionsPackage.REMOVE_VARIABLE_VALUE_ACTION__REMOVE_AT, null, msgs);
			msgs = basicSetRemoveAt(newRemoveAt, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionsPackage.REMOVE_VARIABLE_VALUE_ACTION__REMOVE_AT, newRemoveAt, newRemoveAt));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ActionsPackage.REMOVE_VARIABLE_VALUE_ACTION__REMOVE_AT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActionsPackage.REMOVE_VARIABLE_VALUE_ACTION__IS_REMOVE_DUPLICATES:
