 ...
 * </p>
 * <ul>
 *   <li>{@link uml.actions.impl.BroadcastSignalActionImpl#getSignal <em>Signal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BroadcastSignalActionImpl extends InvocationActionImpl implements BroadcastSignalAction {
		...
		if (signal != null && signal.eIsProxy()) {
			...
			if (signal != oldSignal) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActionsPackage.BROADCAST_SIGNAL_ACTION__SIGNAL, oldSignal, signal));
			}
		}
		return signal;
	}
	...
	public void setSignal(Signal newSignal) {
		...
		signal = newSignal;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionsPackage.BROADCAST_SIGNAL_ACTION__SIGNAL, oldSignal, signal));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActionsPackage.BROADCAST_SIGNAL_ACTION__SIGNAL:
