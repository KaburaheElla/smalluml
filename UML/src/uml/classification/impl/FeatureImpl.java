 ...
 * </p>
 * <ul>
 *   <li>{@link uml.classification.impl.FeatureImpl#getFeaturingClassifier <em>Featuring Classifier</em>}</li>
 *   <li>{@link uml.classification.impl.FeatureImpl#isIsStatic <em>Is Static</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class FeatureImpl extends RedefinableElementImpl implements Feature {
	...
	public void setIsStatic(boolean newIsStatic) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassificationPackage.FEATURE__IS_STATIC, oldIsStatic, isStatic));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ClassificationPackage.FEATURE__FEATURING_CLASSIFIER:
				if (resolve) return getFeaturingClassifier();
				return basicGetFeaturingClassifier();
			case ClassificationPackage.FEATURE__IS_STATIC:
				return isIsStatic();
		}
