 ...
 * </p>
 * <ul>
 *   <li>{@link uml.interactions.impl.InteractionFragmentImpl#getCovered <em>Covered</em>}</li>
 *   <li>{@link uml.interactions.impl.InteractionFragmentImpl#getEnclosingInteraction <em>Enclosing Interaction</em>}</li>
 *   <li>{@link uml.interactions.impl.InteractionFragmentImpl#getEnclosingOperand <em>Enclosing Operand</em>}</li>
 *   <li>{@link uml.interactions.impl.InteractionFragmentImpl#getGeneralOrdering <em>General Ordering</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class InteractionFragmentImpl extends NamedElementImpl implements InteractionFragment {
	...
	protected EClass eStaticClass() {
		return InteractionsPackage.Literals.INTERACTION_FRAGMENT;
	}
	...
	public EList<Lifeline> getCovered() {
		if (covered == null) {
			covered = new EObjectWithInverseResolvingEList.ManyInverse<Lifeline>(Lifeline.class, this, InteractionsPackage.INTERACTION_FRAGMENT__COVERED, InteractionsPackage.LIFELINE__COVERED_BY);
		}
		return covered;
	}
	...
	public Interaction getEnclosingInteraction() {
		if (eContainerFeatureID() != InteractionsPackage.INTERACTION_FRAGMENT__ENCLOSING_INTERACTION) return null;
	...
	public NotificationChain basicSetEnclosingInteraction(Interaction newEnclosingInteraction, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newEnclosingInteraction, InteractionsPackage.INTERACTION_FRAGMENT__ENCLOSING_INTERACTION, msgs);
		return msgs;
	}
	...
	public void setEnclosingInteraction(Interaction newEnclosingInteraction) {
		if (newEnclosingInteraction != eInternalContainer() || (eContainerFeatureID() != InteractionsPackage.INTERACTION_FRAGMENT__ENCLOSING_INTERACTION && newEnclosingInteraction != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, InteractionsPackage.INTERACTION_FRAGMENT__ENCLOSING_INTERACTION, newEnclosingInteraction, newEnclosingInteraction));
	}
	...
	public InteractionOperand getEnclosingOperand() {
		if (eContainerFeatureID() != InteractionsPackage.INTERACTION_FRAGMENT__ENCLOSING_OPERAND) return null;
	...
	public NotificationChain basicSetEnclosingOperand(InteractionOperand newEnclosingOperand, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newEnclosingOperand, InteractionsPackage.INTERACTION_FRAGMENT__ENCLOSING_OPERAND, msgs);
		return msgs;
	}
	...
	public void setEnclosingOperand(InteractionOperand newEnclosingOperand) {
		if (newEnclosingOperand != eInternalContainer() || (eContainerFeatureID() != InteractionsPackage.INTERACTION_FRAGMENT__ENCLOSING_OPERAND && newEnclosingOperand != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, InteractionsPackage.INTERACTION_FRAGMENT__ENCLOSING_OPERAND, newEnclosingOperand, newEnclosingOperand));
	}
	...
	public EList<GeneralOrdering> getGeneralOrdering() {
		if (generalOrdering == null) {
			generalOrdering = new EObjectContainmentEList<GeneralOrdering>(GeneralOrdering.class, this, InteractionsPackage.INTERACTION_FRAGMENT__GENERAL_ORDERING);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case InteractionsPackage.INTERACTION_FRAGMENT__COVERED:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getCovered()).basicAdd(otherEnd, msgs);
			case InteractionsPackage.INTERACTION_FRAGMENT__ENCLOSING_INTERACTION:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetEnclosingInteraction((Interaction)otherEnd, msgs);
			case InteractionsPackage.INTERACTION_FRAGMENT__ENCLOSING_OPERAND:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case InteractionsPackage.INTERACTION_FRAGMENT__GENERAL_ORDERING:
